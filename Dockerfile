...
RUN apt update && \
    ...
    apt install -y libpq-dev python3-setuptools python3-reportlab libfreetype-dev wget git build-essential && \
    apt install -y python3 python3-pip wget cron postgresql postgresql-contrib
