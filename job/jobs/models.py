...
class JobListing(models.Model):
    primary_key = models.CharField(max_length=1000)
    ...
    job_id = models.CharField(max_length=1000, null=True, blank=True, default=None)
    ...
    salary_source = models.CharField(max_length=1000, null=True, blank=True)
    interval = models.CharField(max_length=1000, null=True, blank=True)
    ...
    job_level = models.CharField(max_length=1000, null=True, blank=True)
    job_function = models.CharField(max_length=1000, null=True, blank=True)
    company_industry = models.CharField(max_length=1000, null=True, blank=True)
    ...
    company_num_employees = models.CharField(max_length=1000, null=True, blank=True)
    ...
    ceo_name = models.CharField(max_length=1000, null=True, blank=True)
